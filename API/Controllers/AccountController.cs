...
namespace API.Controllers
{
    public class AccountController : BaseApiController
    {
        ...
        public async Task<ActionResult<UserDto>> Register(RegisterDto registerDto)
        {
            ...
            if (await UserExists(registerDto.Username)) return BadRequest("User nam is taken");
        ...
        {
            var user = await _context.Users.SingleOrDefaultAsync(k => k.UserName == loginDto.Username);
